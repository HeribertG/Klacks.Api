...
namespace Klacks.Api.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260526074248_AddNavigationTargetSynonym")]
    partial class AddNavigationTargetSynonym
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Klacks.Api.Domain.Models.Assistant.SkillSynonym", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_skill_synonyms");

                    b.HasIndex("Language")
                        .HasDatabaseName("ix_skill_synonyms_language");

                    b.HasIndex("SkillName", "Language", "Keyword")
                        .IsUnique()
                        .HasDatabaseName("ix_skill_synonyms_skill_name_language_keyword")
                        .HasFilter("is_deleted = false");
