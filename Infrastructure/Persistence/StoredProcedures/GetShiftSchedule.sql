...
--   show_ungrouped_shifts: Deprecated, kept for backward compatibility (shifts without group are always included)
...
-- Note: Shifts not assigned to any group are always visible regardless of group filter
