...
public static class LLMSeed
{
    public static void SeedData(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.Sql($@"
            ...
            (gen_random_uuid(), 'deepseek-chat', 'DeepSeek V3.2 Chat', 'deepseek-chat', 'deepseek', false, false, 0.00014, 0.00028, 8192, 128000, 'balanced', '{now:yyyy-MM-dd HH:mm:ss}', '{now:yyyy-MM-dd HH:mm:ss}', false),
            (gen_random_uuid(), 'deepseek-reasoner', 'DeepSeek V3.2 Reasoner', 'deepseek-reasoner', 'deepseek', false, false, 0.00055, 0.00219, 8192, 128000, 'reasoning', '{now:yyyy-MM-dd HH:mm:ss}', '{now:yyyy-MM-dd HH:mm:ss}', false),
