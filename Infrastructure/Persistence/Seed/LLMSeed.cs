...
public static class LLMSeed
{
    public static void SeedData(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.Sql($@"
            ...
            (gen_random_uuid(), 'gemini-31-pro', 'Gemini 3.1 Pro', 'gemini-3.1-pro-preview', 'google', true, true, 0.002, 0.012, 64000, 1000000, 'powerful', '{now:yyyy-MM-dd HH:mm:ss}', '{now:yyyy-MM-dd HH:mm:ss}', false),
