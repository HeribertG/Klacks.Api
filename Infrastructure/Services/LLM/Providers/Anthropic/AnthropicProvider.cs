...
namespace Klacks.Api.Infrastructure.Services.LLM.Providers.Anthropic;
...
public class AnthropicProvider : ILLMProvider
{
    ...
    private Domain.Models.LLM.LLMProvider? _providerConfig;
    ...
    public void Configure(Domain.Models.LLM.LLMProvider providerConfig)
    {
