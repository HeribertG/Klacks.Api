...
/// controller that had to leave that base class to widen its authorisation (Option B, 2026-09-12)
/// declares it directly, otherwise its resource would silently lose its route and every skill writing
/// through the own API would fail at the call site.
/// </summary>
