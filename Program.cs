...
builder.Services.AddSingleton<Klacks.Api.Application.Interfaces.IThoroughRecalculationQueue>(
    sp => sp.GetRequiredService<ThoroughRecalculationBackgroundService>());
