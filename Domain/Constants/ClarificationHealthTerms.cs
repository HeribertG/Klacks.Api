...
public static class ClarificationHealthTerms
{
    ...
    public static readonly IReadOnlyDictionary<string, IReadOnlyList<string>> ByLanguage =
        new Dictionary<string, IReadOnlyList<string>>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["ar"] =
            [
                "أعراض", "تشخيص", "حمى", "حمّى", "سخونة", "ألم في", "لديك ألم", "عندك ألم", "تشعر بالألم", "تشعرين بالألم",
                "تتألم", "يؤلم", "تؤلم", "آلام", "أوجاع", "الوجع", "طبيب", "دكتور",
            ...
            ["ko"] =
            [
                "증상", "진단", "열이 나", "열이 있", "열나", "발열", "고열", "통증", "두통", "복통", "요통",
                "의사에게", "의사한테", "의사 선생님", "의사가 뭐라고", "의사가 말", "병원", "진료",
