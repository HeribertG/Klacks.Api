...
/// user never reacted to keeps being reminded, with the last backoff step repeating forever
/// (RepeatLastStepUntilAcknowledged).
/// </summary>
...
public static class ProactiveReminderDefaults
{
    ...
    /// <summary>Once the schedule is exhausted, the last step repeats until the user acknowledges.</summary>
    public const bool RepeatLastStepUntilAcknowledged = true;
