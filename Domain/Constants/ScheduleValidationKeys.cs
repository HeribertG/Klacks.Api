...
public static class ScheduleValidationKeys
{
    ...
    public const string PeriodCapOvertimeApproaching = "schedule.error-list.period-cap-overtime-approaching";
    public const string PeriodCapOvertimeWindow = "schedule.error-list.period-cap-overtime-window";
    public const string PeriodCapOvertimeWindowApproaching = "schedule.error-list.period-cap-overtime-window-approaching";
