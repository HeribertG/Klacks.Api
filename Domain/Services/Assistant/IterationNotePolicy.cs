...
/// inline: a forced confirmation wins over a forced recipe step, which wins over the plan nudge, and the
/// nudge only applies while the turn has not called a tool yet. Extracted so the precedence lives in one
