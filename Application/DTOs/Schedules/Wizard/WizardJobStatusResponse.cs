...
/// <summary>
/// Response of the wizard job status endpoint. Lets clients that missed SignalR events
...
public sealed record WizardJobStatusResponse(
    string Status,
    WizardJobResultDto? Result,
    string? Reason);
