...
/// <summary>
/// Response of the holistic harmonizer job status endpoint. Lets clients that missed SignalR events
...
public sealed record HolisticHarmonizerJobStatusResponse(
    string Status,
    HolisticHarmonizerRunResponse? Result,
    string? Reason);
