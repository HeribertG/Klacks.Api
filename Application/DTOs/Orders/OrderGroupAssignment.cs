...
/// <param name="MatchReason">How the group was found: the customer's group membership, city name, state code or nearest coordinates, plus the address used for the latter three.</param>
