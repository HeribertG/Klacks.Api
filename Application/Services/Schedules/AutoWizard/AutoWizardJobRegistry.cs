...
/// <summary>
/// In-memory registry of running AutoWizard orchestrator jobs and their linked cancellation
/// sources. Singleton; survives HTTP-request scope so background Task.Run can still be cancelled.
/// </summary>
public sealed class AutoWizardJobRegistry
{
