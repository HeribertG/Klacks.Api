...
/// <summary>
/// In-memory registry of running harmonizer jobs and their linked cancellation sources.
/// Singleton; survives HTTP-request scope so background Task.Run can still be cancelled.
/// </summary>
public sealed class HarmonizerJobRegistry
{
