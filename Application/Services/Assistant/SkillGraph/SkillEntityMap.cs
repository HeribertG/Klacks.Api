...
public static class SkillEntityMap
{
    public static readonly IReadOnlyDictionary<string, string[]> Map = new Dictionary<string, string[]>
    {
        ...
        ["add_client_to_nearest_group"] = new[] { "Client", "Group", "GroupItem" },
        ["add_expense"] = new[] { "Expenses" },
        ["add_schedule_command"] = new[] { "ScheduleCommand", "Client" },
        ["add_workchange"] = new[] { "WorkChange", "Work", "Client" },
        ["apply_customer_grouping"] = new[] { "Client", "Group", "GroupItem" },
        ["apply_employee_grouping"] = new[] { "Client", "Group", "GroupItem" },
        ...
        ["geocode_location_groups"] = new[] { "Group" },
        ...
        ["group_ungrouped_by_city_name"] = new[] { "Client", "Group", "GroupItem" },
        ...
        ["propose_customer_grouping"] = new[] { "Client", "Group", "GroupItem" },
        ["propose_employee_grouping"] = new[] { "Client", "Group", "GroupItem" },
