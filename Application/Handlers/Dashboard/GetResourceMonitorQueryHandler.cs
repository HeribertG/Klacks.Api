...
/// <summary>
/// Handler for computing per-day target and actual hours for the resource monitor dashboard card.
/// </summary>
/// <param name="context">Database context for ClientContract, Work, and GroupItem queries</param>
