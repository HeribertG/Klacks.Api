...
/// <summary>
/// Aggregates ScheduleNote entries within a billing period into PeriodIssueDto.
/// Group filter joins via Client → GroupItem. Limited to 500 issues for performance.
/// </summary>
/// <param name="context">EF Core DbContext used directly for the read-only join</param>
