...
namespace Klacks.Api.Application.Constants
{
    public class Settings
    {
        ...
        public const string SCHEDULING_MAX_CAPACITY_UTILIZATION = "SCHEDULING_MAX_CAPACITY_UTILIZATION";

        public const string ESCALATION_STAGE_MIN_MINUTES = "ESCALATION_STAGE_MIN_MINUTES";
        public const string ESCALATION_STAGE_MAX_MINUTES = "ESCALATION_STAGE_MAX_MINUTES";
        public const string ESCALATION_PREP_BUFFER_HOURS = "ESCALATION_PREP_BUFFER_HOURS";
        public const string PROACTIVE_APPROVAL_WINDOW_MINUTES = "PROACTIVE_APPROVAL_WINDOW_MINUTES";
        ...
        public const string ASSISTANT_STT_API_KEY_DEEPGRAM = "ASSISTANT_STT_API_KEY_DEEPGRAM";
        public const string ASSISTANT_STT_API_KEY_GROQ = "ASSISTANT_STT_API_KEY_GROQ";
        public const string ASSISTANT_STT_API_KEY_ASSEMBLYAI = "ASSISTANT_STT_API_KEY_ASSEMBLYAI";
        ...
        public const string KLACKSY_LEARNING_MIN_OCCURRENCES = "KLACKSY_LEARNING_MIN_OCCURRENCES";
