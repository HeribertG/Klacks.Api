...
/// server-side matcher's own verdict on every turn; Scrolled/TargetMiss/PermissionDenied are the
/// browser-reported outcome of a navigation it actually executed; SuspectedMiss is logged by the
/// server itself when the model navigated without a target although a mid-score candidate existed.
/// </summary>
