...
public class PlaceWorkSkill : BaseSkillImplementation
{
    ...
    public PlaceWorkSkill(IMediator mediator, IShiftRepository shiftRepository)
    {
        _mediator = mediator;
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return SkillResult.SuccessResult(
            ...
            $"Placed client {clientId} on shift '{shift.Name}' for {date} ({startTime}–{endTime}, {workTime}h).");
    }
}
