...
/// <summary>
/// Updates an existing qualification's name, description, emoji, time-limited flag, type and country.
/// </summary>
...
/// <param name="Country">Optional country abbreviation this qualification applies to (e.g. "CH", "DE")</param>
public record UpdateQualificationCommand(
    ...
    string? Country) : IRequest<Qualification>;
