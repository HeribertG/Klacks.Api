...
namespace Klacks.Api.Migrations
{
    ...
    [Migration("20250528111233_FixMultiLanguageTableSharing")]
    partial class FixMultiLanguageTableSharing
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Klacks.Api.Models.Associations.GroupVisibility", b =>
                {
                    ...
                    b.HasIndex("ClientId", "GroupId")
                        .HasDatabaseName("ix_group_visibility_client_id_group_id");
            ...
            modelBuilder.Entity("Klacks.Api.Models.Authentification.RefreshToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Klacks.Api.Models.CalendarSelections.CalendarSelection", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Klacks.Api.Models.CalendarSelections.SelectedCalendar", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Klacks.Api.Models.Histories.History", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Klacks.Api.Models.Schedules.Absence", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Klacks.Api.Models.Schedules.Break", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Klacks.Api.Models.Schedules.BreakReason", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Klacks.Api.Models.Schedules.ClientScheduleDetail", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Klacks.Api.Models.Schedules.Shift", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Klacks.Api.Models.Schedules.Work", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Klacks.Api.Models.Settings.CalendarRule", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Klacks.Api.Models.Settings.CommunicationType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Klacks.Api.Models.Settings.Countries", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Klacks.Api.Models.Settings.Macro", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Klacks.Api.Models.Settings.MacroType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Klacks.Api.Models.Settings.PostcodeCH", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Klacks.Api.Models.Settings.Settings", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Klacks.Api.Models.Settings.State", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Klacks.Api.Models.Settings.Vat", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Klacks.Api.Models.Staffs.Address", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Klacks.Api.Models.Staffs.Annotation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Klacks.Api.Models.Staffs.AssignedGroup", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Klacks.Api.Models.Staffs.Client", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Klacks.Api.Models.Staffs.Communication", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Klacks.Api.Models.Authentification.AppUser", b =>
                {
            ...
            modelBuilder.Entity("Klacks.Api.Models.Associations.Membership", b =>
                {
                    b.HasOne("Klacks.Api.Models.Staffs.Client", "Client")
                        .WithOne("Membership")
                        .HasForeignKey("Klacks.Api.Models.Associations.Membership", "ClientId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("Klacks.Api.Models.CalendarSelections.SelectedCalendar", b =>
                {
                    b.HasOne("Klacks.Api.Models.CalendarSelections.CalendarSelection", "CalendarSelection")
            ...
            modelBuilder.Entity("Klacks.Api.Models.Schedules.Absence", b =>
                {
                    b.OwnsOne("Klacks.Api.Datas.MultiLanguage", "Description", b1 =>
                        {
                    ...
                    b.OwnsOne("Klacks.Api.Datas.MultiLanguage", "Name", b1 =>
                        {
                            b1.Property<Guid>("AbsenceId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
            ...
            modelBuilder.Entity("Klacks.Api.Models.Schedules.Break", b =>
                {
                    b.HasOne("Klacks.Api.Models.Schedules.Absence", "Absence")
                        .WithMany()
                        .HasForeignKey("AbsenceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                    ...
                    b.HasOne("Klacks.Api.Models.Schedules.BreakReason", "BreakReason")
                        .WithMany()
