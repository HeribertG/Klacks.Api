...
namespace Klacks.Api.Migrations
{
    ...
    [Migration("20251217082912_AddExpensesEntity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Klacks.Api.Domain.Models.Schedules.ShiftChange", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_shift_change");

                    b.HasIndex("ReplaceClientId")
                        .HasDatabaseName("ix_shift_change_replace_client_id");

                    b.HasIndex("WorkId")
                        .HasDatabaseName("ix_shift_change_work_id");

                    b.ToTable("shift_change", (string)null);
                });
            ...
            modelBuilder.Entity("Klacks.Api.Domain.Models.Schedules.ShiftChange", b =>
                {
                    b.HasOne("Klacks.Api.Domain.Models.Staffs.Client", "ReplaceClient")
                        ...
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("fk_shift_change_client_replace_client_id");
                    ...
                    b.HasOne("Klacks.Api.Domain.Models.Schedules.Work", "Work")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_shift_change_work_work_id");
