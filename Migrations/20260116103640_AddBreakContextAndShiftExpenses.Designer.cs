...
namespace Klacks.Api.Migrations
{
    ...
    [Migration("20260116103640_AddBreakContextAndShiftExpenses")]
    partial class AddBreakContextAndShiftExpenses
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Klacks.Api.Domain.Models.Schedules.BreakContext", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<TimeOnly>("EndBreak")
                        .HasColumnType("time without time zone")
                        .HasColumnName("end_break");

                    b.Property<bool>("IsDeleted")
                        .HasColumnType("boolean")
                        .HasColumnName("is_deleted");

                    b.Property<TimeOnly>("StartBreak")
                        .HasColumnType("time without time zone")
                        .HasColumnName("start_break");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_break_context");

                    b.HasIndex("AbsenceId")
                        .HasDatabaseName("ix_break_context_absence_id");

                    b.HasIndex("IsDeleted", "AbsenceId")
                        .HasDatabaseName("ix_break_context_is_deleted_absence_id");

                    b.ToTable("break_context", (string)null);
                });
            ...
            modelBuilder.Entity("Klacks.Api.Domain.Models.Schedules.BreakContext", b =>
                {
                    b.HasOne("Klacks.Api.Domain.Models.Schedules.Absence", "Absence")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_break_context_absence_absence_id");

                    b.OwnsOne("Klacks.Api.Domain.Common.MultiLanguage", "DetailName", b1 =>
                        {
                            b1.Property<Guid>("BreakContextId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");

                            b1.Property<string>("De")
                                .HasColumnType("text")
                                .HasColumnName("detail_name_de");

                            b1.Property<string>("En")
                                .HasColumnType("text")
                                .HasColumnName("detail_name_en");

                            b1.Property<string>("Fr")
                                .HasColumnType("text")
                                .HasColumnName("detail_name_fr");

                            b1.Property<string>("It")
                                .HasColumnType("text")
                                .HasColumnName("detail_name_it");

                            b1.HasKey("BreakContextId");

                            b1.ToTable("break_context");

                            b1.WithOwner()
                                .HasForeignKey("BreakContextId")
                                .HasConstraintName("fk_break_context_break_context_id");
                        });
